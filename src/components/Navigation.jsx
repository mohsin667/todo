  ...
  return (
    ...
    <nav>
        <ul className='flex gap-[10px] md:gap-[0] flex-wrap md:flex-col'>
            ...
            <li className='flex p-2 gap-2 md:my-[7.5px]  bg-gray-100 rounded-md text-slate-950'><input type="checkbox" className="checked:bg-blue-500 relative left-1 w-4 mr-2" /> Completed</li>
        </ul>
    </nav>
    </>
  )
